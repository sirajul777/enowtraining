...
<ul id="dropdown1" class="dropdown-content">
    <li class="nav-item"><a href="#">English Now Super Camp</a></li>
        ...
        <ul class="collapsible collapsible-accordion">
            <li>
                ...
                <div class="collapsible-body">
                    <ul>
                        <li><a href="#">English Now Super Camp</a></li>
    ...
    <nav class="white">
        <div class="container">
            <div class="nav-wrapper">
                <a href="#" class="brand-logo"><img class="logo" src="<?= base_url('assets'); ?>/img/fixlogo.png" alt="logo" /></a>
